...
# NOTE: Active Storage isn't loaded in config/application.rb (app was generated
# under Rails 5.1 which predates AS as a default), so config.active_storage is
# nil at boot. Left commented; not applicable.
